        ...
        >
          <nav class="flex flex-col gap-1">
            ...
            >
              ...
              >
                <img :src="avatarUrl" :alt="displayName" class="size-full object-cover" referrerpolicy="no-referrer">
              </span>
              <span
                v-else
