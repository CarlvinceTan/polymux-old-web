    ...
    <div class="min-h-0 overflow-y-auto px-4">
      <div class="mx-auto flex min-h-full w-full max-w-lg flex-col">
        <div class="my-auto py-10 sm:py-12">
          <div
            class="rounded-2xl border border-neutral-200/90 bg-white px-5 py-4.5 shadow-[0_1px_3px_rgba(0,0,0,0.06)] sm:px-7 sm:py-7"
          >
            <div class="mb-2 flex w-full justify-center sm:mb-3">
              <NuxtLink
                to="/"
              ...
              >
                <PolymuxLogo class="size-12 shrink-0 sm:size-18" />
              </NuxtLink>
            </div>

            <div v-if="emailSent" class="py-2">
              <h1 class="text-center text-[1.375rem] font-semibold tracking-tight text-neutral-950 sm:text-2xl">
                {{ t('auth.checkYourEmail') }}
              </h1>
              <p class="mt-2.5 text-center text-sm text-neutral-500 sm:mt-3">
                {{ t('auth.emailConfirmationSent', { email }) }}
              </p>
              <div class="mt-6 flex justify-center sm:mt-8">
                <NuxtLink
                  to="/sign-in"
                  class="flex h-10 items-center justify-center rounded-md bg-neutral-950 px-6 text-sm font-medium text-white transition-opacity hover:opacity-90"
                >
                  {{ t('common.signIn') }}
                </NuxtLink>
              </div>
            ...
            <template v-else>
              ...
              <p class="mt-1 text-center text-sm text-neutral-500 sm:mt-1.5">
              ...
              <div class="mt-4 flex flex-col gap-2.5 sm:mt-5 sm:gap-3">
                ...
                <form
                  class="flex w-full flex-col gap-2.5 sm:gap-3"
                  novalidate
                  ...
                  <div class="flex w-full flex-col gap-2.5 sm:gap-3">
                    ...
                    <div>
                      <label
                        ...
                        class="block text-sm font-medium text-neutral-800"
                      >{{ t('auth.confirmYourPassword') }}</label>
                      <input
