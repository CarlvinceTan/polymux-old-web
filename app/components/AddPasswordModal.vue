      ...
      >
        ...
        >
          <div class="flex items-center justify-between border-b border-neutral-200 px-6 py-4">
            <h2 class="text-body-lg font-semibold text-neutral-950">{{ t('vault.passwords.addPasswordTitle') }}</h2>
            <button
              type="button"
          ...
          <div class="space-y-4 p-6">
            ...
            <div>
              <label class="block text-label-md font-medium text-neutral-600 mb-2">{{ t('vault.passwords.passwordLabel') }}</label>
              <div class="relative">
                <input
                  v-model="password"
